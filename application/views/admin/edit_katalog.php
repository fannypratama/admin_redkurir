                                                    ...
                                                    <form action="<?= base_url('welcome/edit_katalog2/'.$katalog->id_barang)?>" method="post">
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="nm_brg" value="<?php echo set_value('nama barang', $katalog->nama_barang)?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="ktgr_brg"
                                                                     value="<?php echo set_value('kategori', $katalog->Kategori)?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Harga Barang</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="hrg_brg"
                                                                     value="<?php echo set_value('harga_barang', $katalog->harga_barang)?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Stok Barang</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="stok_barang"
                                                                     value="<?php echo set_value('stok_barang', $katalog->stok_barang)?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Gambar Barang</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="gmb_brg"
                                                                     value="<?php echo set_value('gambar_barang', $katalog->gambar_barang)?>"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
